...
<div class="col-md-7 tab-style-1">
    <ul class="nav nav-tabs">
        <li class="active"><a href="#tab-1" data-toggle="tab">Infrastruktur</a></li>
        <li><a href="#tab-2" data-toggle="tab">Dokumentasi</a></li>
        <li><a href="#tab-3" data-toggle="tab">Cakupan</a></li>
        <li><a href="#tab-4" data-toggle="tab">Kualitas</a></li>
    </ul>
