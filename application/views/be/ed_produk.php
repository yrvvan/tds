            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url(); ?>Crun0/edit_produk" enctype="multipart/form-data">
                            <input type="text" name="id_produk" required value="<?php echo $data->id_produk; ?>" hidden="TRUE">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control ckeditor" name="editor1" rows="6" required><?php echo $data->deskripsi; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
